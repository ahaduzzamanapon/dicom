<div class="card border-0 shadow-sm mb-4">
    ...
    <div class="card-body">
        ...
        <div class="border rounded p-3 mb-4">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <?php echo Form::select('imageCategory', ['single' => 'Single', 'dable' => 'Double', 'multiple' => 'Multiple'], null, ['class' => 'form-select', 'id' => 'imageCategory']); ?>
                ...
                <div class="col-md-4">
                    ...
                    <?php echo Form::file('dicomFile', ['class' => 'form-control']); ?>
        ...
        <div class="border rounded p-3 mb-4">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <?php echo Form::text('patientId', null, ['class' => 'form-control']); ?>

                </div>

                <div class="col-md-3">
                    <label for="patientName" class="form-label">Patient Name</label>
                    <?php echo Form::text('patientName', null, ['class' => 'form-control']); ?>

                </div>

                <div class="col-md-3">
                    <label for="patientAge" class="form-label">Patient Age</label>
                    <?php echo Form::text('patientAge', null, ['class' => 'form-control']); ?>

                </div>

                <div class="col-md-3">
                    <label for="patientSex" class="form-label">Patient Sex</label>
                    <?php echo Form::text('patientSex', null, ['class' => 'form-control']); ?>

                </div>

                <div class="col-md-3">
                    <label for="refBy" class="form-label">Referred By</label>
                    <?php echo Form::text('refBy', null, ['class' => 'form-control']); ?>
            ...
            <div class="mb-4">
                ...
                <?php echo Form::textarea('patientHistory', null, ['class' => 'form-control', 'rows' => 3]); ?>
        ...
        <div class="border rounded p-3 mb-4">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <?php echo Form::select('doctor', \App\Models\User::where('group_id', \App\Models\RoleAndPermission::where('key', 'doctor')->value('id'))->pluck('name', 'id')->prepend('All'), null, ['class' => 'form-select']); ?>
        ...
        <div class="text-end">
            <?php echo Form::submit('Save', ['class' => 'btn btn-primary me-2']); ?>

            <a href="<?php echo e(route('patientreports.index')); ?>" class="btn btn-outline-danger">Cancel</a>
        </div>
...
<?php $__env->startSection('script'); ?>
    <script src="<?php echo e(asset('assets/js/dicomParser.min.js')); ?>" defer></script>
    <script>
...
<?php /**PATH C:\laragon\www\dicom\resources\views/patientreports/fields.blade.php ENDPATH**/ ?>